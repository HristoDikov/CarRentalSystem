...
namespace CarRentalSystem.Infrastructure.Persistance.Migrations
{
    ...
    [Migration("20210125212551_UserTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarRentalSystem.Domain.Models.Dealer.Dealer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CarRentalSystem.Domain.Models.CarAds.CarAd", b =>
                {
                    ...
                    b.HasOne("CarRentalSystem.Domain.Models.Dealer.Dealer", null)
                        .WithMany("CarAds")
                    ...
                    b.OwnsOne("CarRentalSystem.Domain.Models.CarAds.Options", "Options", b1 =>
                        {
                            ...
                            b1.OwnsOne("CarRentalSystem.Domain.Models.CarAds.TransmissonType", "TransmissionType", b2 =>
                                {
            ...
            modelBuilder.Entity("CarRentalSystem.Domain.Models.Dealer.Dealer", b =>
                {
                    b.OwnsOne("CarRentalSystem.Domain.Models.Dealer.PhoneNumber", "PhoneNumber", b1 =>
                        {
            ...
            modelBuilder.Entity("CarRentalSystem.Infrastructure.Identity.User", b =>
                {
                    b.HasOne("CarRentalSystem.Domain.Models.Dealer.Dealer", "Dealer")
                        .WithOne()
